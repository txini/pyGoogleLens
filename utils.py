...
def initialize_driver(download_path=None, headless=False):
    try:
        ...
        # Desactivar la pantalla de bienvenida y otras opciones
        ...
        chrome_options.add_argument("--kiosk-printing")  # Evitar el diálogo de impresión
        ...
        # Configurar las preferencias de impresión en PDF
        settings = {
        ...
        prefs = {
            ...
            "savefile.default_directory": download_path,  # Ubicación para guardar el PDF
            "printing.default_destination_selection_rules": {
                "kind": "local",
                "namePattern": "Save as PDF",
                "idPattern": "Save as PDF",
            },
            "print.always_print_silent": True,  # Imprimir sin mostrar el diálogo
            "print.show_print_progress": False,  # No mostrar progreso de impresión
